      ...
      <div className="flex flex-col lg:flex-row items-center gap-20">
        ...
        >
          <div className="flex items-center gap-2 mb-8">
            ...
            <span className="text-sm text-slate-400 uppercase tracking-widest font-inter">Find campaigns</span>
          </div>
...
Set up your brand community on Qwick to manage campaigns and collaborate with creators.          </p>
        </motion.div>
