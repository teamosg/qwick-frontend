...
Stay in control of your budget        </h2>
        <p className="text-lg text-slate-500 mb-8 max-w-2xl font-inter leading-relaxed">
Track posts and performance. Extend your campaign or refund unused funds directly from your dashboard.</p>      </motion.div>
   ...
   <div className='flex items-center justify-center p-5'>
    ...
    <motion.div
          ...
          >
            <button className="w-full sm:w-auto cursor-pointer px-10 py-5 bg-white text-black border  rounded-2xl hover:bg-slate-100 transition-all flex items-center justify-center gap-3 group shadow-2xl shadow-white/10 uppercase tracking-widest text-sm font-inter">
             Create Campaign
