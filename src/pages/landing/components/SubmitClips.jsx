  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 lg:py-24 flex flex-col lg:flex-row-reverse items-center gap-10 sm:gap-14 md:gap-16 lg:gap-20">
      ...
      >
        ...
        <p className="text-base sm:text-lg text-[#9B9B9B] mb-4 sm:mb-6 lg:mb-8 max-w-lg mx-auto lg:mx-0 font-inter leading-relaxed">
          Publish content on your social platforms following the campaign
          guidelines. Submit your post link through Qwick to track views and
          performance.{" "}
        </p>
      </motion.div>
