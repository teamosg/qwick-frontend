    ...
    <section className="relative min-h-[100vh] w-full overflow-hidden flex items-center">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <button className="w-full sm:w-auto px-10 cursor-pointer py-5 bg-white text-black  rounded-2xl hover:bg-slate-100 transition-all flex items-center justify-center gap-3 group shadow-2xl shadow-white/10 uppercase tracking-widest text-sm font-inter">
              Get Started
