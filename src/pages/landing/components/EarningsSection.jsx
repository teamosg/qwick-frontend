    ...
    <>
      <section className="container mx-auto px-6 py-24 flex flex-col lg:flex-row items-center gap-20">
        ...
        >
          ...
          <p className="text-lg text-[#9B9B9B] mb-8 max-w-2xl font-inter leading-relaxed">
            Start earning as your content gains views. Track your earnings and
            manage withdrawals directly from your dashboard.{" "}
          </p>
        </motion.div>
      ...
      <div className="flex items-center justify-center p-5">
        <Link to="/sign-in">
          ...
          >
            <button className="w-full cursor-pointer sm:w-auto px-10 py-5 bg-white text-black  hover:bg-[#EF0C18] hover:text-white border  rounded-2xl  transition-all flex items-center justify-center gap-3 group shadow-2xl shadow-white/10 uppercase tracking-widest text-sm font-inter">
              Explore Campaigns
              <ArrowRight
                size={20}
