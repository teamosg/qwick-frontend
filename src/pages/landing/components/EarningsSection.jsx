    ...
    <>
      ...
      <div className="flex items-center justify-center px-4 sm:px-6 py-4 sm:p-5">
        <Link to="/sign-in" className="w-full sm:w-auto max-w-sm sm:max-w-none">
          ...
          >
            <button className="w-full cursor-pointer sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-white text-black hover:bg-[#EF0C18] hover:text-white border rounded-xl sm:rounded-2xl transition-all flex items-center justify-center gap-3 group shadow-2xl shadow-white/10 uppercase tracking-widest text-xs sm:text-sm font-inter">
              Explore Campaigns
              <ArrowRight
                size={20}
