  ...
  const reviewsData = {
    ...
    reviews: [
      ...
      },
      {
        ...
        rating: 4,
        text: "Great product overall, very satisfied with the quality and service. Would definitely recommend to others.",
        date: "20/02/2024",
        likes: 3,
        replies: [],
      },
      {
        ...
        rating: 3,
        text: "Product is okay, but could be better. The delivery was slow and the packaging could be improved.",
        date: "18/02/2024",
        likes: 1,
        replies: [],
      },
      {
        ...
        rating: 5,
        text: "Absolutely love this product! It's exactly what I was looking for and the customer service is excellent.",
        date: "15/02/2024",
        likes: 7,
        replies: [],
      },
