...
const VerifyAccount = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="w-full md:w-1/2 px-6 md:px-12 lg:px-20 pb-6 md:pb-10 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="mb-8 text-center">
            ...
            <h2 className="text-[#000] text-center font-[Inter] text-[20px] sm:text-[24px] md:text-[28px] lg:text-[30px] not-italic font-medium leading-[120%] uppercase mb-2">
              VERIFY YOUR ACCOUNT
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="text-[#0D0D12] font-[Inter] text-[14px] not-italic font-medium leading-[155%] mb-4 block">
                Enter your OTP
              </label>
              <div className="flex justify-between space-x-2">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="w-full h-12 text-center border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#003933] focus:border-[#003933] text-lg"
                  />
                ))}
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#003933] text-white py-2.5 px-4 rounded-md hover:bg-[#002822] transition mt-6 font-medium cursor-pointer"
            >
              Confirm
            </button>
          </form>
      ...
      <div className="hidden md:block md:w-1/2 bg-[#FFF]">
