      ...
      <div className="w-full md:w-1/2 px-6 md:px-12 lg:px-20 pb-6 md:pb-10 flex flex-col bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-md mx-auto w-full flex flex-col h-full justify-center">
          <div className="mb-8 text-center">
            <h2 className="text-gray-900 dark:text-white text-center font-[Inter] text-[20px] sm:text-[24px] md:text-[28px] lg:text-[30px] not-italic font-medium leading-[120%] uppercase mb-2">
              VERIFY YOUR ACCOUNT
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="text-gray-900 dark:text-gray-200 font-[Inter] text-[14px] not-italic font-medium leading-[155%] mb-4 block">
                Enter your OTP
              </label>
              <div className="flex justify-between space-x-2">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="w-full h-12 text-center border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-[#003933] dark:focus:ring-primary focus:border-[#003933] dark:focus:border-primary bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-lg"
                  />
                ))}
              </div>
            </div>
