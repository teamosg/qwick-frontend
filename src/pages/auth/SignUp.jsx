 ...
 const toggleDarkMode = () => {
  ...
  return (
    <div className={`min-h-screen flex`}>
      {/* Left side - Form */}
      <div className="w-full md:w-1/2 px-6 md:px-12 lg:px-20 pb-6 md:pb-10 flex flex-col justify-center bg-gray-50 dark:bg-gray-900">
...
className="text-[#003933] dark:text-white"
        ...
        <div className="max-w-md mx-auto w-full flex flex-col justify-center">
          ...
          <div className="flex md:flex-row flex-col items-center gap-2 md:gap-3.5">
            <button className="w-full py-2.5 px-4 md:px-2 lg:px-4 border border-gray-300 dark:border-gray-700 rounded-md text-center font-medium flex items-center justify-between gap-2 hover:bg-gray-100 dark:hover:bg-gray-800 transition cursor-pointer">
            ...
            <button className="w-full py-2.5 px-4 border border-gray-300 dark:border-gray-700 rounded-md text-center font-medium flex items-center justify-between gap-2 hover:bg-gray-100 dark:hover:bg-gray-800 transition cursor-pointer">
              <div className="flex items-center gap-2">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-[#003933] dark:focus:ring-primary focus:border-[#003933] dark:focus:border-primary bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                  />
                </div>
                {errors.firstName && (
            ...
            <button
              type="submit"
              className="w-full bg-[#003933] dark:bg-primary text-white py-2.5 px-4 rounded-md hover:bg-[#002822] dark:hover:bg-primary/90 transition mt-6 font-medium cursor-pointer"
            >
              Sign Up
            </button>
          </form>
