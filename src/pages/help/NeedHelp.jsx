  ...
  return (
    <div className="p-12 dark:bg-zinc-950 max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center border pr-3 gap-2 border-gray-500/30 h-[46px] rounded-md overflow-hidden w-full">
          <input
            ...
            className="w-full h-full pl-5 outline-none text-gray-500 placeholder-gray-500 text-sm bg-background"
          />
          <button type="button">
            <Search />
          </button>
      ...
      <div className="text-center">
        ...
        <Link className="bg-foreground-strong dark:bg-foreground-strong text-white px-4 py-2 sm:py-4 sm:px-10 rounded-3xl sm:rounded-full hover:bg-foreground dark:hover:bg-foreground-strong/90 transition font-medium cursor-pointer inline-block mt-8">
          Chat with us
        </Link>
      </div>
    </div>
