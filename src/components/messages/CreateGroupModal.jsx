            ...
            <div className="bg-white dark:bg-[#171717] rounded-2xl shadow-2xl w-full max-w-md max-h-[600px] flex flex-col">
              ...
              <div className="p-4 border-b border-gray-200 dark:border-[#282828]">
                <input
                  ...
                  className={`w-full px-3 py-2 text-sm border rounded-lg bg-gray-50 dark:bg-[#232323] text-gray-900 dark:text-white 
                    ${nameError ? "border-red-500 focus:ring-red-500" : "border-gray-300 dark:border-[#282828]"}
