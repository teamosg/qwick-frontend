    ...
    <div className="p-4 md:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="relative mb-6">
        ...
        <Input
          ...
          className="pl-10 pr-4 py-2 w-full rounded-lg border-gray-300 dark:border-zinc-800 dark:bg-zinc-800 dark:text-white focus:border-border-strong focus:ring-1 focus:ring-ring"
        />
      </div>
      ...
      <div className="space-y-3">
        {filteredTransactions.length > 0 ? (
          filteredTransactions.map((transaction) => (
            <div
              key={transaction.id}
              className="flex items-center justify-between p-3 sm:p-4 bg-muted/50 dark:bg-zinc-800 hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-lg transition-colors border border-transparent dark:border-zinc-800"
            >
              ...
              <div className="flex items-center gap-4 flex-1">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-foreground-subtle dark:text-zinc-400 mt-1">
                    <span className="font-medium text-foreground-strong dark:text-foreground-strong">
