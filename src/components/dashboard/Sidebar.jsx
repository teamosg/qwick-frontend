  ...
  return (
    <NavLink
      ...
      className={({ isActive, isPending }) =>
        `flex items-center space-x-3 p-3 rounded-lg text-[#717171] border  ${
          isActive || isPending
            ? 'bg-sidebar-link-active !text-[#003933]  border-[#003933]'
  ...
  return (
    <div className="bg-sidebar h-full flex flex-col border-r border-sidebar-border">
      ...
      <div className="flex-1 px-3 py-2 space-y-1">
        <NavItem icon={<Compass size={20} />} text="Explore" to="/" />
        <NavItem icon={<Search size={20} />} text="Discover" to="/discover" />
        <NavItem
