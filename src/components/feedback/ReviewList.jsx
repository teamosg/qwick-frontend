          ...
          {showReplyForm && (
            <form onSubmit={handleReplySubmit} className="mt-4">
              <textarea
                ...
                className="w-full p-3 border border-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-colors"
                rows={2}
              />
          ...
          {replies.map((reply) => (
            <div key={reply.id} className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <button className="flex items-center space-x-1 mt-2 text-xs text-gray-500 hover:text-gray-700 transition-colors">
