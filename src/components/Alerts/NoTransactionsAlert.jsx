...
export function NoTransactionsAlert() {
  return (
    <Alert className="flex flex-col items-center justify-center gap-2 bg-gray-50 dark:bg-[#2E2E2E] border border-gray-200 dark:border-gray-700 text-center py-6 rounded-none">
